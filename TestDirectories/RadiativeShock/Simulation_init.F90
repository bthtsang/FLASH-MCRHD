...
#include "Flash.h"
  ...
  call RuntimeParameters_get('sim_bulkvelaxis', sim_bulkvelaxis)
  call RuntimeParameters_get('sim_bulkvelval', sim_bulkvelval)

  ! Gathering physical constants 
  ...
  if (pt_meshMe == 0) print *, "a_rad =", a_rad
  if (pt_meshMe == 0) print *, "clight =", clight
